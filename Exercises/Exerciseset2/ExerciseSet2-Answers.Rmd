...
5. In a financial crisis, most assets will lose value at the same time, thus if they all move in the same direction (downwards), the correlation between the assets will increase. Thus, fewer components will be required to explain the data as they are all now (mostly) correlated.
